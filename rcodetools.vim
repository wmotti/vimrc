...
" taken from https://github.com/rcodetools/rcodetools/blob/master/misc/README.vim
" plain annotations
...
" Remove # => markers
vmap <silent> <F24> ms:call RemoveRubyEval()<CR>
nmap <silent> <F24> V<F24>
imap <silent> <F24> <ESC><F24>a
